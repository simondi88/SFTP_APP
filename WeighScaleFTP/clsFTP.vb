...
#Region "Main Class Variable Declarations"
    ...
    Public Const BLOCK_SIZE As Integer = 1024
...
#Region "Public Subs and Functions"
    ...
    Public Function GetFileList(ByVal sMask As String) As String()
        ...
        Dim bytes As Int32
        Dim separator As Char = ControlChars.Lf
        Dim mess() As String
    ...
    '
    ' Upload a file.
    Public Sub UploadFile(ByVal dFileName As String, ByVal sFileName As String)
        UploadFile(dFileName, sFileName, False)
    End Sub

    '
    ' Upload a file and set the resume flag.
    Public Sub UploadFile(ByVal dFileName As String, _
...
#Region "Private Subs and Functions"
    ...
    Private Sub ReadReply()
        ...
        System.Diagnostics.Debug.WriteLine(m_sReply)
    End Sub
...
#Region " *** Example Code *** "
    ...
    '        'sess.RemoteHost = "microsoft"
    '        'sess.RemoteUser = "ftpuser"
    '        'sess.RemotePassword = "password"
    '        '-------------------------------------------
    ...
    '            sess.ChangeDirectory("Area1")
    '            sess.ChangeDirectory("Section1")

    '            'sess.CreateDirectory("Subby1")
    '            sess.ChangeDirectory("Subby1")
    '            sess.SetBinaryMode(True)

    '            ' Upload a file.
    '            'sess.UploadFile("d:\general\secureapps.pdf")

    '            ' Download a file.
    '            'sess.DownloadFile("secureapps.pdf", "d:\general\secureapps.pdf")

    '            ' Remove a file from the FTP Site.
    '            If (sess.DeleteFile("secureapps.pdf")) Then
    '                Response.Write("File has been removed from FTP Site")
    '                'MessageBox.Show("File has been removed from FTP Site")
    '            Else
    '                Response.Write("Unable to remove file from FTP Site.  Message from server: " & sess.MessageString & "<br>")
    '                'MessageBox.Show("Unable to remove file from FTP Site")
    '            End If

    '            ' Rename a file on the FTP Site.
    '            'If (sess.RenameFile("secureapps.pdf", "newapp.pdf")) Then
    '            '    Response.Write("File has been renamed")
    '            '    MessageBox.Show("File has been renamed")
    '            'End If

    '            'sess.ChangeDirectory("..")
    '            'If (sess.RemoveDirectory("Subby1")) Then
    '            '    Response.Write("Directory has been removed<br>")
    '            '    ' MessageBox.Show("Directory has been removed")
    '            'Else
    '            '    Response.Write("Unable to remove the directory.  Message from server: " & sess.MessageString & "<br>")
    ...
    '        Response.Write("Message from FTP Server was: " & sess.MessageString)

    '        ' WinForms
    '        'Messagebox.Show(ex.Message)
    '        'MessageBox.show("Message from FTP Server was: " & sess.MessageString)
    '    Finally
    '        '
